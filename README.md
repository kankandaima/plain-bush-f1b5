...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/plain-bush-f1b5#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/plain-bush-f1b5
```

A live public deployment of this template is available at [https://plain-bush-f1b5.templates.workers.dev](https://plain-bush-f1b5.templates.workers.dev)
